...
/**
 * the parameters of DSFMT following definitions are in
 * dSFMT-paramsXXXX.h file.
 */

// Below we escape the hash symbol (number sign) with a backslash to
// avoid Doxygen warnings like the following:
//
// dSFMT-params.h:28: Warning: explicit link request to 'define' could not be resolved

...
#include <string.h>
#include <stdlib.h>
#include "private/dSFMT-params.h"
 ...
 */
inline static void
do_recursion (w128_t * r, w128_t * a, w128_t * b, w128_t * lung)
{
 ...
 */
inline static void
do_recursion (w128_t * r, w128_t * a, w128_t * b, w128_t * u)
{
  __m128i v, w, x, y, z;
 ...
 */
inline static void
gen_rand_array_c1o2 (dsfmt_t * dsfmt, w128_t * array, int size)
{
  int i, j;
  w128_t lung;
 ...
 */
inline static void
gen_rand_array_c0o1 (dsfmt_t * dsfmt, w128_t * array, int size)
{
  int i, j;
  w128_t lung;
 ...
 */
inline static void
gen_rand_array_o0o1 (dsfmt_t * dsfmt, w128_t * array, int size)
{
  int i, j;
  w128_t lung;
 ...
 */
inline static void
gen_rand_array_o0c1 (dsfmt_t * dsfmt, w128_t * array, int size)
{
  int i, j;
  w128_t lung;
 ...
 */
static void
period_certification (dsfmt_t * dsfmt)
{
 ...
 */
void
dsfmt_gen_rand_all (dsfmt_t * dsfmt)
{
  int i;
  w128_t lung;
 ...
 */
void
dsfmt_fill_array_close1_open2 (dsfmt_t * dsfmt, double array[], int size)
{
  assert (size % 2 == 0);
 ...
 */
void
dsfmt_fill_array_open_close (dsfmt_t * dsfmt, double array[], int size)
{
  assert (size % 2 == 0);
  assert (size >= DSFMT_N64);
 ...
 */
void
dsfmt_fill_array_close_open (dsfmt_t * dsfmt, double array[], int size)
{
  assert (size % 2 == 0);
  assert (size >= DSFMT_N64);
 ...
 */
void
dsfmt_fill_array_open_open (dsfmt_t * dsfmt, double array[], int size)
{
  assert (size % 2 == 0);
  assert (size >= DSFMT_N64);
 ...
 */
void
dsfmt_chk_init_gen_rand (dsfmt_t * dsfmt, uint32_t seed, int mexp)
{
  int i;
  uint32_t *psfmt;
 ...
 */
void
dsfmt_chk_init_by_array (dsfmt_t * dsfmt, uint32_t init_key[],

...
// we always want 19937 without requiring the "user" to define it
#define DSFMT_MEXP 19937

#if defined (__POWEPC__) || defined (_ARCH_PPC) || defined (__ppc__)
// Hey, PPC doesn't have SSE!
#else
// our build process requires SSE2
//   um ... (below todo added by khk, temporarily)
// TODO: commented this define out and added a conditional define to
// configure.ac for draft Arm build ... but haven't looked at
// the implications of not having SSE available, which the comment
// above suggests might ought to be investigated.
//#define HAVE_SSE2
#endif
...
/** dsfmt mexp for check */
  ...
  void dsfmt_fill_array_open_close (dsfmt_t * dsfmt, double array[],
                                    int size);
  void dsfmt_fill_array_close_open (dsfmt_t * dsfmt, double array[],
                                    int size);
 ...
 */
  inline static void dsfmt_gv_fill_array_close1_open2 (double array[],
                                                       int size)
  {
 ...
 */
  inline static void dsfmt_init_by_array (dsfmt_t * dsfmt,
 ...
 */
  inline static void dsfmt_gv_init_by_array (uint32_t init_key[],
                                             int key_length)
  {
